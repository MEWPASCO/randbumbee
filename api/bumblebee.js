// api/bumblebee.js — fetch-only, streams image/* bytes
...
const QUERIES = [
  "bumblebee",
  "bumblebee macro photo",
  "Bombus terrestris macro photo",
  "bumblebee on flower close up",
  "Bombus pascuorum macro photography",
  "bumblebee collecting pollen macro",
  "bumblebee in flight macro photo",
  "wild bumblebee macro photo",
  "bumblebee portrait macro nature photo"
];

const FALLBACKS = [
  "https://upload.wikimedia.org/wikipedia/commons/5/5a/Bombus_terrestris_queen.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/3/3e/Bombus_pascuorum-2.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/1/1a/Bombus_hortorum_-_Common_Garden_Bumblebee.jpg",
  "https://upload.wikimedia.org/wikipedia/commons/7/74/Bombus_pratorum_May_2007-1.jpg"
];
...
export default async function handler(req,res){
  ...
  if(!serpKey){
    ...
    res.setHeader("Content-Disposition", `inline; filename="bumblebee.${data.ext}"`);
  ...
  try{
    ...
    return res.status(404).json({ ok:false, error:"no_usable_bumblebee_found" });
  }
}
